...
public class ContactUsPageWtihRobotWay extends PageBase {

	public ContactUsPageWtihRobotWay(WebDriver driver) {
		super(driver);
	}
	...
	public void userCanContactUs(String name,String email,String subject
			,String message) throws InterruptedException, AWTException {
